...
function Settings({ user }) {
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <p className="mt-2 text-gray-600 mb-6">Manage your account preferences and settings</p>
      <div className="flex flex-col md:flex-row gap-6">
        {/* Settings Navigation */}
        <div className="md:w-64 flex-shrink-0 flex flex-col justify-between min-h-[400px]">
